				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="viewcategory.php" class="menu__link scroll">CATEGORY</a></li>
							
							
							
							<li class="menu__item"><a href="login.php">LOGIN</a></li>
							<li class="menu__item"><a href="userfooter.php" class="menu__link scroll">Contact Us</a></li>
